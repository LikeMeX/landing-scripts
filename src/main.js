              ...
              i[o].map(function (n) {
                n[o].map(function (a) {
                  (a[o] = a[o] instanceof Array ? a[o] : [a[o]]),
                    a[o].map(function (e) {
                      var t = {district: r(a[0]), amphoe: r(n[0]), province: r(i[0]), zipcode: e};
                      2 === o &&
                        ((t.district_code = a[1] || !1), (t.amphoe_code = n[1] || !1), (t.province_code = i[1] || !1)),
                        c.push(t);
                    });
                });
              });
      ...
      var l = function (e, t, a) {
        ...
        return (
          (o = s) &&
            ...
            r + s < p && c + s < d && (o += l(e.substr(r + s, p - r - s), t.substr(c + s, d - c - s), !1))),
          !1 === a ? o : e === t ? 100 : d < p ? Math.floor((o / p) * 100) : Math.floor((o / d) * 100)
        );
      };
      !(function (a) {
        var e,
        ...
        switch (('json' !== t && 'zip' !== t && (t = o.database.split('.').pop()), t)) {
          ...
          default:
            throw new Error(
              'Unknown database type: "' + o.database_type + '". Please define database_type explicitly (json or zip)'
            );
        }
      })(function (i) {
        $.Thailand.DB = i;
